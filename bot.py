...
foo = [u"Я ебал твою мать арматурой, уёбище!", u"Пиздец ты доблоёбище нахуй", u"Твоя мать так охуенно сосёт:P",
...
u"Береги жопу, а не то трахну!!))))", u"Ты мне тут не пизди, а убери свою мать у меня из под столаXDXDXD Если сможешь;)", u"Соси хуй, быдло!", u"MQ!"]
